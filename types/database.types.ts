  ...
  public: {
    Tables: {
      ...
      item: {
        ...
        Relationships: [
          {
            foreignKeyName: "item_created_by_user_id_fkey"
      ...
      user: {
        Row: {
          ...
          shoe_size_region:
            | Database["public"]["Enums"]["shoe_size_region_type"]
            | null
      ...
      wardrobe_item: {
        Row: {
          ...
          size: Database["public"]["Enums"]["outfit_size_type"] | null
    ...
    Functions: {
      ...
      discard_wardrobe_item: {
        Args: { p_wardrobe_item_id: string }
        Returns: undefined
      }
    }
    Enums: {
